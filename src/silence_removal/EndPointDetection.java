...
public class EndPointDetection {
	...
	private EndPointDetection(float[] originalSignal, int samplingRate) {
	...
	public static float[] compress(float[] originalSignal, int samplingRate) {
		EndPointDetection epd = new EndPointDetection(originalSignal, samplingRate);
		return epd.doEndPointDetection();
	}
